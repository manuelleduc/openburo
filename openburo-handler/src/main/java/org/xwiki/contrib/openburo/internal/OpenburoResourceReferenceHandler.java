...
import static org.xwiki.contrib.openburo.OpenburoResourceReference.TYPE;
...
@Named(OPENBURO_ID)
@Singleton
public class OpenburoResourceReferenceHandler extends AbstractResourceReferenceHandler<ResourceType>
{
    @Inject
